 ...
 *
 * Manages TMUX panes for subagent sessions
 */

import type { PluginInput } from "@opencode-ai/plugin"
import type { TmuxConfig, TrackedSession } from "./types"
import {
  spawnTmuxPane,
  closeTmuxPane,
  isInsideTmux,
} from "./tmux-utils"
import { POLL_INTERVAL_BACKGROUND_MS, SESSION_MISSING_GRACE_MS } from "./constants"

/**
 * TMUX Session Manager
 *
 * Handles creation and cleanup of TMUX panes for subagent sessions
 */
export class TmuxSessionManager {
  ...
  /**
   * Poll sessions to check their status
   */
  ...
  /**
   * Cleanup all sessions and stop polling
   */
