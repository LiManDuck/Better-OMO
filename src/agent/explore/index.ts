/**
 * Explore Agent - Read-only codebase exploration agent
 */
 ...
 *
 * This agent has read-only permissions and is used for:
 * - Finding files and code
 * - Understanding codebase structure
 * - Cross-module pattern discovery
 */
export const createExploreAgent: AgentFactory = (model: string): AgentConfig => {
  return {
    description:
